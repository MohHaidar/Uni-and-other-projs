...
;Circuit 3.c,41 :: 		ADCON0 = 0b00000001;    //12 bit , channel 0 , enable ADC
	MOVLW      1
	MOVWF      ADCON0+0
;Circuit 3.c,42 :: 		ADCON1 = 0b11010001;    //2's complement result , Fosc/16 , Vref- = Vss , Vref+ = external
	MOVLW      209
	MOVWF      ADCON1+0
...
;Circuit 3.c,75 :: 		PSMC1PRL = 0x8F;
	MOVLW      143
	MOVWF      PSMC1PRL+0
;Circuit 3.c,79 :: 		set_DC(100);
	MOVLW      100
	MOVWF      FARG_set_DC+0
	MOVLW      0
	MOVWF      FARG_set_DC+1
	CALL       _set_DC+0
;Circuit 3.c,82 :: 		PSMC1PHH = 0x00;
	CLRF       PSMC1PHH+0
;Circuit 3.c,83 :: 		PSMC1PHL = 0x00;
	CLRF       PSMC1PHL+0
;Circuit 3.c,86 :: 		PSMC1OEN.b0 = 1;
	BSF        PSMC1OEN+0, 0
;Circuit 3.c,87 :: 		PSMC1STR0.b0 = 1;
	BSF        PSMC1STR0+0, 0
;Circuit 3.c,88 :: 		PSMC1POL = 0b00000000;
	CLRF       PSMC1POL+0
;Circuit 3.c,91 :: 		PSMC1PRS = 0b00000001;
	MOVLW      1
	MOVWF      PSMC1PRS+0
;Circuit 3.c,92 :: 		PSMC1PHS = 0b00000001;
	MOVLW      1
	MOVWF      PSMC1PHS+0
;Circuit 3.c,93 :: 		PSMC1DCS = 0b00000001;
	MOVLW      1
	MOVWF      PSMC1DCS+0
;Circuit 3.c,96 :: 		PSMC1CON = 0b11000000;
	MOVLW      192
	MOVWF      PSMC1CON+0
;Circuit 3.c,99 :: 		TRISC.b0 = 0;
	BCF        TRISC+0, 0
;Circuit 3.c,103 :: 		PIE4.b4 = 1;      //enable PSMC1 interrupts
	BSF        PIE4+0, 4
;Circuit 3.c,104 :: 		INTCON.b6 = 1;    //enable peripheral interrupts
	BSF        INTCON+0, 6
;Circuit 3.c,105 :: 		INTCON.b7 = 1;    //enable all active interruprs
	BSF        INTCON+0, 7
;Circuit 3.c,106 :: 		PSMC1INT.b5 = 1;  //enable timebase duty cycle interrupts
	BSF        PSMC1INT+0, 5
;Circuit 3.c,111 :: 		UART1_Init(9600);
	BSF        BAUDCON+0, 3
	CLRF       SPBRGH+0
	MOVLW      103
	MOVWF      SPBRG+0
