...
%0002 %LOGSUM logsum(x,d,k)=log(sum(k.*exp(x),d))
%0003 %
%0004 % Usage: (1) y=logsum(x) % log(sum(exp(x)))
%0005 %        (2) f=0.1*log(10); y=logsm(x*f)/f;  % add powers in dB
%0006 %
50007 % Inputs:  X(M,N,...) data matrix to sum
...
%0019 %      Version: $Id: logsum.m 8178 2016-07-12 06:57:25Z dmb $
%%0020 %
